...
<body>
                    ...
                    <% if (isLoggedIn) { %>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                <li><a class="dropdown-item" href="profile.jsp"><i class="fas fa-user-circle me-2"></i> Profile</a></li>
        ...
        <div class="row g-5">
            ...
            <div class="col-md-4">
                ...
                <div class="d-grid gap-2 mb-4">
                    <a href="DownloadServlet?id=<%= book.getBookId() %>" class="btn btn-primary btn-lg">
                        <i class="fas fa-download"></i> Download
                    </a>
                    <a href="reader.jsp?id=<%= book.getBookId() %>" class="btn btn-outline-primary btn-lg">
                ...
                <% if (isLoggedIn) { %>
                    <div class="d-grid gap-2 mb-4">
                        ...
                        <button class="btn btn-outline-primary btn-bookmark <%= isBookmarked ? "active" : "" %>" onclick="toggleBookmark(<%= book.getBookId() %>)">
    ...
    <script>
        ...
        function toggleBookmark(bookId) {
            <% if (isLoggedIn) { %>
                fetch('UserBookServlet?action=toggleBookmark&bookId=' + bookId, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        alert('Failed to update bookmark status: ' + data.message);
                    }
                })
                .catch(error => {
        ...
        function updateReadingStatus(bookId, status, progress) {
            <% if (isLoggedIn) { %>
                fetch('UserBookServlet?action=updateStatus', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
                    body: 'bookId=' + bookId + '&status=' + status + '&progress=' + progress
                })
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        alert('Failed to update reading status: ' + data.message);
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
